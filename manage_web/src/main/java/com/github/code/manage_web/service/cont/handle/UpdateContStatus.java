...
@Slf4j
@Component
public class UpdateContStatus implements UpdateStrategy {
    ...
    public Map<String, Object> select(AccountInfo accountInfo) {
        ...
        resultMap.put("contStatus", contract.getContStatus());
        return resultMap;
    }
    ...
    public boolean update(RunInstanceDto data, Object value) {
        ...
        try {
            return contractServiceImpl.updateContInfoByContId(contId, value, "cont_status");
        } catch (Exception e){
