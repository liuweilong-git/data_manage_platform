...
@Slf4j
@Component
public class UpdateContType implements UpdateStrategy {
    ...
    public Map<String, Object> select(AccountInfo accountInfo) {
        ...
        resultMap.put("contType", contract.getContType());
        return resultMap;
    }
    ...
    public boolean update(RunInstanceDto data, Object value) {
        ...
        try {
            return contractServiceImpl.updateContInfoByContId(contId, value, "cont_type");
        } catch (Exception e){
