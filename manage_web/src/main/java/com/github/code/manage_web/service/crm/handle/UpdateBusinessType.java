...
@Slf4j
@Component
public class UpdateBusinessType implements UpdateStrategy {
    @Autowired
    ...
    public Map<String, Object> select(AccountInfo accountInfo) {
        ...
        resultMap.put("businessType", customers.getBusinessType());
        return resultMap;
    }
    ...
    public boolean update(RunInstanceDto data, Object value) {
        ...
        try {
            return customersServiceImpl.updateCustomerInfoByCustomerID(customer_id, value, "business_type");
        } catch (Exception e){
